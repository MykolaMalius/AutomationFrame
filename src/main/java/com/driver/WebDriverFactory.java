...
import com.allure.EventHandler;
...
public class WebDriverFactory {
	...
	public static final String URL = "https://" + USERNAME + ":" + AUTOMATE_KEY + "@hub-cloud.browserstack.pages/wd/hub";
...
//				FirefoxProfile myprofile = profile.getProfile("IDL");
				setFirefox();
...
//				dc.setCapability("project", "pages.mmjtraine");
//
...
//				webDriver = new RemoteWebDriver(new URL(URL), dc);
	...
	public static void setFirefox() throws Exception {
		String osName = System.getProperty("os.name").toLowerCase();
		StringBuffer firefoxBinaryPath = new StringBuffer("src/main/java/resources/");
